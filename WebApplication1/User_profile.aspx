<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="User_profile.aspx.cs" Inherits="WebApplication1.User_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label ID="label1" class="badge rounded-pill text-bg-dark" runat="server" Text="Your status"></asp:Label>
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-8 mx-auto">
                                        <center>
                                            <div class="form-group d-grid gap-2">
                                                <asp:Button CssClass="btn btn-success btn-block" ID="Button2" runat="server" Text="Update" OnClick="Button2_Click" />
                                                <br />
            ...
            <div class="col-md-6">
                <div class="card" style="padding: 10px; margin: 10px; background-color: antiquewhite">
                    <div class="card-header">

                        <center>
                            <br />
                            <h1 style="font-family: 'Times New Roman', Times, serif; color: darkgreen; font-weight: bolder">Your Timeline</h1>
                            <br />
                        </center>
                    ...
                    <br />
                    <div class="card-body">
                        <div class="card" style="padding: 20px; margin: 20px; background-color: antiquewhite">
                            <div class="card-header">
                                <center>
                                    <h2 style="font-family: 'Times New Roman', Times, serif; color: darkgreen; font-weight: bolder">Habit Tracker</h2>
                                </center>

                            </div>
                            <div class="card-body">
                                <div>
                                    <p><strong>Habit Tracker:</strong> Stay on top of your goals and build healthy habits with our intuitive habit tracking tool.</p>
                                    <a href="HabitTracking.aspx" class="btn btn-outline-success">Your Habit Tracker</a>
                                </div>
                        ...
                        <div class="card" style="padding: 20px; margin: 20px; background-color: antiquewhite">
                            <div class="card-header">
                                <center>
                                    <h2 style="font-family: 'Times New Roman', Times, serif; color: darkgreen; font-weight: bolder">Journal writing</h2>
                                </center>

                            </div>
                            <div class="card-body">
                                <p><strong>Journaling:</strong> Capture your thoughts, experiences, and reflections in a private journal, and gain valuable insights into your journey.</p>
                                <a href="Journaling.aspx" class="btn btn-outline-success">Your Journal</a>
                            </div>
                        ...
                        <div class="card" style="padding: 20px; margin: 20px; background-color: antiquewhite">
                            <div class="card-header">
                                <center>
                                    <h2 style="font-family: 'Times New Roman', Times, serif; color: darkgreen; font-weight: bolder">Task Manager</h2>
                                </center>

                            </div>
                            <div class="card-body">
                                <p><strong>Task Manager:</strong> Organize your tasks, set priorities, and increase productivity with our efficient task management system.</p>
                                <a href="ToDoList.aspx" class="btn btn-outline-success">Yours Task Manager</a>
